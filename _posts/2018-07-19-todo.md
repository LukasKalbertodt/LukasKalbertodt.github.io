...
As you might have noticed, **this is a long post**. My hope is that this text serves as an extensive reference for the topic of "GAT workarounds". I try to discuss every important detail and show several use cases. I expect most readers to skip large parts of this post.
